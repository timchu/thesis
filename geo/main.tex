...
\input{geo/intro} %%% Section 1

%\newpage

\input{geo/result} %%% Section 2 Summary of Low Dimension Results
\input{geo/preli} %%% Section 3 Preliminaries
\input{geo/equiv} %%% Section 4 Equivalence of Matrix-Vector Multiplication and Solving Linear Systems
\input{geo/hardness} %%% Section 5 Matrix-Vector Multiplication
\input{geo/sparsifier_lip} %%% Section 6 Sparsifying Multiplicatively Lipschitz Functions in Almost Linear Time
\input{geo/sparsifier_ip} %%% Section 7 Sparsifiers for $|<x,y>|$
\input{geo/lapl_hard} %%% Section 8 Hardness of Sparsifying and Solving
\input{geo/fastmm} %%% Section 9 Fast Multipole Method
\input{geo/ntk} %%% Section 10 Neural Tangent Kernel
